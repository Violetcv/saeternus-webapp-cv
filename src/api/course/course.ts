...
const courses: CourseInfo[] = [
  ...
  {
    courseId: '2',
    title: 'Q GIS Certification',
    header:
      'Certificate Course in Remote Sensing and Geographical Information System (QGIS)',
    image: '/assets/gis.png',
    tags: ['Q GIS', 'Mapping'],
    prevPrice: '₹7,000',
    currentPrice: '₹3,540',
...
const detailedCourses: CourseDetails[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description:
          'GIS, Vector Operation, Raster Operation, GIS analysis, Map Preparation, Hands on Practice',
        day: 'Day 16',
      },
    ],
    relatedCourses: ['2', '5'],
    startDate: 'October 4th, 2024',
    whatYouWillLearn: [
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        title: 'Data Management Tools',
        description:
          'Vector Operations in GIS Platform, Q GIS-Clip Management and Mosaic, Raster and Vector Data Clipping, Making Sample Location with GPS Location, Hands on Practice',
        day: 'Day 6',
      },
      {
        title: 'Spatial Analyst I',
